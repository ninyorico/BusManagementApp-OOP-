...
public class TourGuideSignup extends javax.swing.JFrame {

 
    public TourGuideSignup() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelCreateAcoount.setText("already have an account? click here");
    ...
    private void jButtonCancel1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCancel1ActionPerformed
        TourGuideLogin tgl = new TourGuideLogin();
        tgl.setVisible(true);
        tgl.pack();
        tgl.setLocationRelativeTo(null);
        tgl.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TourGuideSignup().setVisible(true);
            }
        });
    }
